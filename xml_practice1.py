...
#Add a new decade to the new anime genre.

#-Add the Batman from into the anime genre under the correct decade WITHOUT just typing it out. (Append it from the old genre to the new one). 

#-Delete Batman from the old genre.

add_anime = root.find("./genre[@category='Anime']")
new_genre = ET.SubElement(add_anime, 'decade')
